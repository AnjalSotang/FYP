...
import { AlignLeft, MoreHorizontal, Edit, Trash2, Star } from 'lucide-react';
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-40 bg-navy-900 rounded-md shadow-lg border border-navy-600">
                          <DropdownMenuItem asChild>
                            <Link to={`/edit/${id}`} className="flex items-center px-4 py-3 text-gray-300 hover:bg-navy-700 hover:text-lime-300 transition-colors">
