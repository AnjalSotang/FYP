    ...
    >
      ...
      <div className="p-6">
        <div className="flex flex-col md:flex-row gap-6">
          {/* Image Section */}
          <div className="relative h-20 md:h-auto md:w-1/4 rounded-md overflow-hidden z-0">
          {imageUrl ? (
              <img
          ...
          <div className="flex flex-col flex-grow">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium ${getDifficultyClass(exercise.difficulty_level)}`}
              >
                {exercise.difficulty_levelfficulty}
              </span>
              ...
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium ${exercise.is_active ? "bg-[#A3E635] text-[#111827]" : "bg-red-900 text-red-300"}`}
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mt-auto">
              ...
              <div>
                ...
                <p className="text-gray-400">{formatDate(exercise.createdAt)}</p>
              </div>
              <div>
                <p className="font-semibold text-gray-200">Updated:</p>
                <p className="text-gray-400">{formatDate(exercise.updatedAt)}</p>
              </div>
              {/* <div>
                <p className="font-semibold text-gray-200">Exercises:</p>
                <p className="text-gray-400">{excercise.exercises.length} exercises</p>
              </div> */}
            </div>
          </div>
        </div>
