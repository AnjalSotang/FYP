...
const {addExcercise, getAllExcercises, getAllExcercisesForAdmin, getExcercise, deleteExcercise, updateExcercise, searchExercises, getExerciseMetrics} = require("../controller.js/admin/excerciseController")
...
router.get('/admin/excercises/metrics', getExerciseMetrics)
