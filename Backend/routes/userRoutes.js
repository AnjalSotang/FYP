...
const {register, login, user_forgotPassword, resetPassword, changePassword, updateUserProfile, getUserProfile, deleteAccount, getAdminProfile} = require("../controller.js/authController")
